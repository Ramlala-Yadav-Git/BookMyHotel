        ...
        <>
            <div style={{ width: "73%", margin: "auto", backgroundColor: "white", padding: "10px", display: "flex", justifyContent: "space-between" }}>
                ...
                <div>
                    ...
                    <p style={p}>BookMyHotel.com for Travel Agents</p>
                </div>
                <div>
                    <p style={p}>Coronavirus (COVID-19) FAQs</p>
                    <p style={p}>About BookMyHotel.com</p>
            ...
            <div style={{ width: "73%", margin: "auto", textAlign: "center", fontSize: "12px" }}>Copyright © 1996–2021 BookMyHotel.com™. All rights reserved.</div>
